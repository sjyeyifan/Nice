package com.prw.nice.presenter;
...
public class MainPresenter extends RxPresenter<MainActivity> {
    ...
    private static final String NAME_KEY = MainPresenter.class.getName() +
            "#name";
        ...
        restartableLatestCache(REQUEST_ITEMS,
                new Func0<Observable<ServerAPI.Response>>() {
                    ...
                    public Observable<ServerAPI.Response> call() {
                        return BaseApplication.getServerAPI()
                                .getItems(name.split("\\s+")[0], name.split
                                        ("\\s+")[1])
                ...
                new Action2<MainActivity, ServerAPI.Response>() {
                    @Override
                    public void call(MainActivity activity, ServerAPI
                            .Response response) {
                ...
                new Action2<MainActivity, Throwable>() {
                    @Override
                    public void call(MainActivity activity, Throwable
                            throwable) {
